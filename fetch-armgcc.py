...
if __name__ == "__main__":
    ...
    if requested_arch == "aarch64" and requested_gcc_version == "12.3.rel1":
        os.mkdir("./arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi")
        os.mkdir("./arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi/bin")
        with open("./arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi/bin/README", "w") as f:
            f.write("not available!")
        print("arm-gnu-toolchain-12.3.rel1-x86_64-arm-none-eabi")
        exit(0)
